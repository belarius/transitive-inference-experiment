// Derived Lists Testing Task (Order Maintained)
// client-side
    ...
    for(i=0;i<5;i++){
      for(j=0;j<5;j++){
        if(i != j){
          session_length = session_length + 1;
          trial_number.push(session_length.toString());
          temp_array.push([picture_array[list_order_3[i]], picture_array[list_order_3[j]]]);
        }
      }
    }
    shuffle(temp_array);
    ...
    for(i=0;i<5;i++){
      for(j=0;j<5;j++){
        if(i != j){
          session_length = session_length + 1;
          trial_number.push(session_length.toString());
          temp_array.push([picture_array[list_order_4[i]], picture_array[list_order_4[j]]]);
        }
      }
    }
    shuffle(temp_array);
    ...
    for(i=0;i<5;i++){
      for(j=0;j<5;j++){
        if(i != j){
          session_length = session_length + 1;
          trial_number.push(session_length.toString());
          temp_array.push([picture_array[list_order_5[i]], picture_array[list_order_5[j]]]);
        }
      }
    }
    shuffle(temp_array);
