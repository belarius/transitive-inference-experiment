// Derived Lists Using Two Training Lists For Human Children (Order Maintained)
// client-side
...
function resetVars(newTrialBool){
  ...
  countc = Math.floor(counta/24);
  countd = counta % 24;
  for(var i = 0; i<countc; i++){
	  addStar(24,i*0.04 + 0.02,0.05);
  }
  addStar(countd,countc*0.04 + 0.02,0.05);
...
function addStar(starnum, relX, relY){
  ...
  starImg.src = "pics/Star-24-" + starnum + ".spc";
