// Transitive Inference Task With Massed Trials Manipulation (Start of Session)
// client-side
...
function sessionStarter(){
  ...
  for(b=0;b<10;b++){
    ...
    temp_array.push([picture_array[5], picture_array[6]]);
    session_length = session_length + 1;
    trial_number.push(session_length.toString());
    temp_array.push([picture_array[6], picture_array[5]]);
    shuffle(temp_array);
  ...
  for(b=0;b<5;b++){
    ...
    for(i=0;i<listLength-1;i++){
      session_length = session_length + 1;
      trial_number.push(session_length.toString());
      temp_array.push([picture_array[i], picture_array[6]]);
      session_length = session_length + 1;
      trial_number.push(session_length.toString());
      temp_array.push([picture_array[6], picture_array[i]]);
    }
    for(i=0;i<listLength-2;i++){
      session_length = session_length + 1;
      trial_number.push(session_length.toString());
      temp_array.push([picture_array[i], picture_array[5]]);
      session_length = session_length + 1;
      trial_number.push(session_length.toString());
      temp_array.push([picture_array[5], picture_array[i]]);
    }
    for(i=0;i<listLength-3;i++){
      session_length = session_length + 1;
      trial_number.push(session_length.toString());
      temp_array.push([picture_array[i], picture_array[i+1]]);
      session_length = session_length + 1;
      trial_number.push(session_length.toString());
      temp_array.push([picture_array[i+1], picture_array[i]]);
    }
    shuffle(temp_array);
    for(i=0;i<temp_array.length;i++){
      combination_array.push(temp_array[i]);
